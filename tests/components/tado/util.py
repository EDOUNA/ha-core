...
async def async_init_integration(
    ...
    with aioresponses() as m:
        m.post("https://auth.tado.com/oauth/token", payload=load_fixture(token_fixture))
        m.get("https://my.tado.com/api/v2/me", payload=load_fixture(me_fixture))
        m.get(
            "https://my.tado.com/api/v2/homes/1/weather",
            payload=load_fixture(weather_fixture),
        )
        m.get(
            "https://my.tado.com/api/v2/homes/1/state",
            payload=load_fixture(home_state_fixture),
        )
        m.get(
            "https://my.tado.com/api/v2/homes/1/devices",
            payload=load_fixture(devices_fixture),
        )
        m.get(
            "https://my.tado.com/api/v2/homes/1/mobileDevices",
            payload=load_fixture(mobile_devices_fixture),
        )
        m.get(
        ...
        m.get(
            ...
            payload=load_fixture(device_temp_offset),
        )
        m.get(
        ...
        m.get(
            ...
            payload=load_fixture(zone_6_state_fixture),
        )
        m.get(
            "https://my.tado.com/api/v2/homes/1/zones/5/state",
            payload=load_fixture(zone_5_state_fixture),
        )
        m.get(
            "https://my.tado.com/api/v2/homes/1/zones/4/state",
            payload=load_fixture(zone_4_state_fixture),
        )
        m.get(
            "https://my.tado.com/api/v2/homes/1/zones/3/state",
            payload=load_fixture(zone_3_state_fixture),
        )
        m.get(
            "https://my.tado.com/api/v2/homes/1/zones/2/state",
            payload=load_fixture(zone_2_state_fixture),
        )
        m.get(
            "https://my.tado.com/api/v2/homes/1/zones/1/state",
            payload=load_fixture(zone_1_state_fixture),
        )
